"""Engine and session for the itemcode database. Own database, own engine — never MM OS's or
any other service's. Portable across sqlite (dev/test) and Postgres (production) because
app/models.py uses only portable SQLAlchemy types. Mirrors servicedesk/app/db.py exactly.
"""
